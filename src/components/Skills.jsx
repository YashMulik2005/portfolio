        ...
        <div div className=' p-7' id='skills' >
            ...
            <div className=' flex p-5 flex-col sm:flex-row'>
                <div className=' sm:w-1/4 w-full flex justify-center'>
                    <div className={`flex flex-col w-56 p-5 overflow-hidden items-center ${first ? " h-72" : "h-32"} ${theme == "dark" ? " shadow-xl" : "shadow-[15px_15px_41px_#b1b1b1,-15px_-15px_41px_#ffffff]"} m-2`}>
                ...
                <div className=' sm:w-1/4 w-full flex justify-center'>
                    <div className={`flex flex-col w-56 p-5 overflow-hidden items-center ${second ? " h-72" : "h-32"} ${theme == "dark" ? " shadow-xl" : "shadow-[15px_15px_41px_#b1b1b1,-15px_-15px_41px_#ffffff]"} m-2`}>
                        {/* <img src={photo} alt="" className=' w-1/2 h-1/2' /> */}
                        <section>
                            <FaReact size={50} />
                        </section>
                ...
                <div className=' sm:w-1/4 w-full flex justify-center'>
                    <div className={`flex flex-col w-56 p-5 overflow-hidden items-center ${third ? "h-72" : "h-32"} ${theme == "dark" ? " shadow-xl" : "shadow-[15px_15px_41px_#b1b1b1,-15px_-15px_41px_#ffffff]"} m-2`}>
                        {/* <img src={photo} alt="" className=' w-1/2 h-1/2' /> */}
                        <section>
                            <FaNodeJs size={50} />
                        </section>
                ...
                <div className=' sm:w-1/4 w-full flex justify-center'>
                    <div className={`flex flex-col w-56 p-5 overflow-hidden items-center ${fourth ? "h-72" : "h-32"} ${theme == "dark" ? " shadow-xl" : "shadow-[15px_15px_41px_#b1b1b1,-15px_-15px_41px_#ffffff]"} m-2`}>
                        {/* <img src={photo} alt="" className=' w-1/2 h-1/2' /> */}
                        <section>
                            <DiCss3 size={50} />
                        </section>
