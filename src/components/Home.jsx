...
function Home() {
    ...
    return (
        <div className=' flex flex-col sm:flex-row mt-2 justify-center relative' onClick={handlenav}>
            ...
            >
                ...
                <span className=' flex'><button className={`${theme == 'dark' ? ' bg-green-700' : ' bg-green-800'} text-white py-1 px-3 rounded-sm m-2 text-lg font-bold`}><a href="mailto:yashmulik95@gmail.com">Send Email</a></button><h1 className='m-2 text-xl font-bold'><u><a href='#project'>See Project</a></u></h1></span>
            </motion.div>
