    ...
    return (
        <div className=' flex flex-col sm:flex-row mt-2'>
            <div className=' flex flex-col sm:w-1/2 items-centers sm:items-start justify-center sm:h-[88vh] px-10 py-5 sm:py-0'>
                ...
                <h1 className=' text-2xl font-bold my-1'>Web <span className=' text-green-500'>Developer .</span></h1>
                ...
                <span className=' flex'><button className=' bg-green-500 text-white py-1 px-3 rounded-sm m-2 text-lg font-bold'>Send Email</button><h1 className='m-2 text-xl font-bold'><u>See Project</u></h1></span>
            </div>
