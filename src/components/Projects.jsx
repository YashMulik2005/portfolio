...
function Projects() {
    ...
    return (
        <div className={`${theme == "dark" ? "bg-[#0E0B0B]" : "bg-slate-300"}  p-5 min-[900px]:h-[65vh] flex flex-col justify-center items-center sm:px-20 `} id="project" onClick={handlenav}>
            <h1 className=' text-center text-3xl font-bold mt-5'>My Projects</h1>

            <div className=' flex flex-col min-[900px]:flex-row p-2'>
                <div className=' group min-[900px]:w-1/3 w-full m-2 p-3'>
                    <div className='group h-48 relative hover:scale-110 '>
                        ...
                        <div className='flex flex-col absolute bottom-0 left-0 opacity-90 w-full h-0 group-hover:h-full bg-gradient-to-b from-green-400 to-green-950  justify-center items-center transition-all ease-linear duration-300 rounded ' >
                            <h1 className=' text-white text-center font-bold text-xl hidden  group-hover:block '>NEWS 24/7</h1>
                ...
                <div className={`min-[900px]:w-1/3 w-full m-2 p-3  `} >
                    <div className='group h-48 relative hover:scale-110 '>
                        <img src={notes} alt="" className=' bg-grad w-full h-[100%] opacity-100 rounded-md group-hover:opacity-35' />

                        <div className='flex flex-col absolute bottom-0 left-0 opacity-90 w-full h-0 group-hover:h-full bg-gradient-to-b from-green-400 to-green-950  justify-center items-center transition-all ease-linear duration-300 rounded '>
                            <h1 className=' text-white text-center font-bold text-xl hidden  group-hover:block '>What to do</h1>
                            <section className=' group-hover:flex justify-center p-3 hidden'>
                                <section className=' bg-white rounded-full mx-2'>
                ...
                <div className=' min-[900px]:w-1/3 w-full m-2 p-3'>
                    <div className='group h-48 relative hover:scale-110 '>
                        ...
                        <div className='flex flex-col absolute bottom-0 left-0 opacity-90 w-full h-0 group-hover:h-full bg-gradient-to-b from-green-400 to-green-950  justify-center items-center transition-all ease-linear duration-300 rounded '>
                            <h1 className=' text-white text-center font-bold text-xl hidden  group-hover:block '>Coding solutions</h1>
                            <section className='group-hover:flex justify-center p-3 hidden'>
                                <section className='bg-white rounded-full mx-2'>
